...
Drop in any GGUF LLMs you wish that support function-calling/tool-use into the models folder. Reccommend 2+ billion parameter models for best results. Higher parameter models may perform better, if your hardware can run them at a timely pace.

# Dependencies
Python, Web Browser, bring your own GGUF LLM, will download an appropriate release of llama.cpp for your detected hardware on first startup.
