...
# 🛠️ Installation
1. Simply download and extract the repo to your preferred directory. If placed in the BF2_Modtools directory, the assistant may be able to access your addon data folders.
2. Drop in any GGUF LLMs you wish that supports function-calling/tool-use into the models folder. Use at least a 2+ billion parameter model for best results. Higher parameter models may perform better, if your hardware can run them at a timely pace.
